...
$(() => {
  ...
  $('.slick-slide').each((index, item) => {
    $(item).on('click', () => {
      ...
      if ($(item).next().hasClass('slick-center'))
        return $slideshow.slick('slickGoTo', parseInt($slideshow.slick('slickCurrentSlide') - 1));
      if ($(item).prev().hasClass('slick-center'))
        return $slideshow.slick('slickGoTo', parseInt($slideshow.slick('slickCurrentSlide') + 1));
    });
  });
  ...
  function setWrapperToTop(toTop) {
    ...
    if (wrapper) {
      toTop
        ? wrapper.classList.add('bringModalToTop')
...
$.fn.selectbox = function () {
  ...
  $('.selectboxss .selectboxssvalue').click(function () {
    ...
    if (currentHeight < 100 || currentHeight == selectDefaultHeight) {
      ...
      $(this)
        ...
        .attr(
          'style',
          'border-radius: 1000px;transition: 0.2s;transform: rotate(180deg);padding: 0px 0px 0px 10px;'
        );
    }
  ...
  $('li.selectoption').click(function () {
    ...
    $(this)
      .closest('.selectboxss')
      .find('.arrowselect')
      .attr('style', 'rotate(0deg);padding: 0px 10px 0px 0px;');
